...
class GMap extends React.Component {
    ...
    constructor(props) {
        super(props);
        const foto = props.index ? props.images[props.index] : null;
        this.state = {
            selectedPlace: {},
            currentLocation: {},
            foto: foto,
    ...
    componentDidMount() {
        const foto = this.props.index ? this.props.images[this.props.index] : null;
        if (foto && foto.position) {
    ...
    onMapClicked(g, e, r) {
        if (this.props.changeCoordinates) {
