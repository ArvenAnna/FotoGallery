...
let Scroll = class Scroll extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  onWheel(e) {
    ...
    this.text.style.bottom = parseInt(textStyle.bottom) + (e.deltaY > 0 ? -1 : 1) + 'px';
  }
  ...
  onDrag(e) {
    ...
    this.scroll.style.bottom = parseInt(scrollStyle.bottom) + (this.isScrollDown(e) ? -1 : 1) + 'px';
...
//# sourceMappingURL=0.b2cc5debd7634a179cae.hot-update.js.map