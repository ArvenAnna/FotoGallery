...
let AvatarEditor = (_temp2 = _class = class AvatarEditor extends __WEBPACK_IMPORTED_MODULE_1_react___default.a.Component {
    ...
    paintImage(context, image, scaleFactor = pixelRatio) {
        if (image.resource) {
            ...
            context.drawImage(image.resource, 0, 0, image.width, image.height, 0, 0, this.props.width, this.props.height);
...
//# sourceMappingURL=0.079ac37ada0298eae0ef.hot-update.js.map