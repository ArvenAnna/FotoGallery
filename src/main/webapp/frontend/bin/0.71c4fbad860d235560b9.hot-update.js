...
let FotoSlider = class FotoSlider extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__scroll_Scroll__["a" /* default */], null);
    }
};
...
let Scroll = class Scroll extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  onWheel() {
    this.text.style.transform = transform.currentStyle || window.getComputedStyle(transform);
  }
...
//# sourceMappingURL=0.71c4fbad860d235560b9.hot-update.js.map