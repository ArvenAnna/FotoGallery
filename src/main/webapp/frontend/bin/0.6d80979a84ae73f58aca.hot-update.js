...
&.increase {
  ...
  ${animation('increase', `${props => props.animationTime}s`)};
  
  .__animation_with_time(increase);
...
//# sourceMappingURL=0.6d80979a84ae73f58aca.hot-update.js.map