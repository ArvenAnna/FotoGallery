...
let Scroll = class Scroll extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  onDrag(e) {
    ...
    if (parseInt(scrollStyle.top) - 1 < 0 || parseInt(scrollStyle.bottom) + 1 < 0) {
      return;
    }

    this.scroll.style.top = parseInt(scrollStyle.top) + (e.clientY > this.state.currentScrollY ? 1 : -1) + 'px';
...
//# sourceMappingURL=0.6713bf19687c6e235035.hot-update.js.map