...
let Picture = class Picture extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  mouseLeave(e) {
    !this.state.magnified && this.chooseAnimation(e, 'fade_out', 'from');
  }

  mouseEnter(e) {
    !this.state.magnified && this.chooseAnimation(e, 'fade_in', 'to');
  }
...
//# sourceMappingURL=0.49c1cb73c78320fd8653.hot-update.js.map