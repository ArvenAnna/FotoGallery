...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__VideoCard__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__VideoCard___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__VideoCard__);
...
let Card = class Card extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    rotateImage() {
        __WEBPACK_IMPORTED_MODULE_4__HttpService__["a" /* default */].doPut(routesModule.routes.ROTATE_FOTO, { src: this.props.picture.src }).then(result => {
    ...
    render() {
        ...
        return openPicture ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            this.isVideo() ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__VideoCard__["default"], { src: picture.src }) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'drag_image', src: picture.src }),
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/home/hanna/My/Gallery/FotoGallery/src/main/webapp/frontend/components/editAlbum/VideoCard.js'");

/***/ })

})
//# sourceMappingURL=0.82e6c183361205ed686a.hot-update.js.map