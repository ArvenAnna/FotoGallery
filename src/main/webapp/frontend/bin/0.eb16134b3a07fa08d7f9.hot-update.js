...
let EditAlbum = (_dec = Object(__WEBPACK_IMPORTED_MODULE_6_react_redux_es_connect_connect__["a" /* default */])(store => ({}), {
    ...
    saveFotoDescription(picture) {
        const newPictures = Object.assign({}, this.state.album.images);
        const editedPicture = newPictures.find(p => p == picture.id);
        editedPicture.name = this.ref.input.value();
        editedPicture.text = this.ref.text.value();
        const newAlbum = Object.assign({}, _extends({}, this.state.album, {
            images: newPictures
        }));
        this.setState({ album: newAlbum });
...
//# sourceMappingURL=0.eb16134b3a07fa08d7f9.hot-update.js.map