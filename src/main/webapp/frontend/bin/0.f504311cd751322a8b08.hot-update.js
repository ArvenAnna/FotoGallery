    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                foto.position && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_google_maps_react__["Marker"], { onClick: foto => this.onMarkerClick(foto),
                    key: 'active',
                    title: foto.name,
                    name: foto.name,
                ...
                images && images.filter(image => image.position).map((image, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_google_maps_react__["Marker"], { onClick: image => this.onMarkerClick(image),
                    key: index,
                    title: image.name,
                    name: image.name,
            ...
            this.state.mapFoto && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'map_foto' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: this.state.mapFoto }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Icons__["a" /* CrossIcon */], { onClick: () => this.setState({ mapFoto: null }) })
            )
        );
    }
}) || _class);
...
//# sourceMappingURL=0.f504311cd751322a8b08.hot-update.js.map