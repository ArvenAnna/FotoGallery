...
let Scroll = class Scroll extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    scrollTo(getScrollDirectionAsNumber) {
        ...
        if (scrollTop <= 0 && getScrollDirectionAsNumber() < 0 || scrollTop > scrollGap - 2 && getScrollDirectionAsNumber() > 0 || getScrollDirectionAsNumber() == 0) {
            return;
        }

        const nextScrollTop = scrollTop + getScrollDirectionAsNumber() * this.speed;

        this.scroll.style.top = scrollTop + getScrollDirectionAsNumber() + 'px';
...
//# sourceMappingURL=0.7c3a9a367c239d92badd.hot-update.js.map